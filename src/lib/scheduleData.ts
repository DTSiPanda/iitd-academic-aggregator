...
export const LECTURE_SLOTS: Slot[] = [
  ...
  { course: 'Climate Change',          code: 'CVL2001', time: '12:00 PM', venue: 'LH 108',          type: 'lecture', days: ['Monday', 'Tuesday', 'Friday'], note: 'Friday class depends on professor' },
  ...
  { course: 'Traffic & Transport',     code: 'CVL2601', time: '9:00 AM',  venue: 'LH 416',          type: 'lecture', days: ['Tuesday', 'Wednesday'] },
...
export const LAB_SLOTS_BY_GROUP: Record<LabGroup, Slot[]> = {
  group1: [
    ...
    { course: 'Geology Lab',           code: 'CVP2401', time: '2:00 PM', venue: 'Block IV, Rm 331',  type: 'lab', days: ['Friday'], note: 'F slot (PF1)' },
    { course: 'Hydraulics Lab',        code: 'CVP2702', time: '3:00 PM', venue: 'Block V, V312',      type: 'lab', days: ['Thursday'] },
    { course: 'Eng Systems Lab',       code: 'MEP1000', time: '9:00 AM', venue: 'CSC',                type: 'lab', days: ['Monday'], note: 'Gr 1 & 2 together' },
  ],
  group2: [
    ...
    { course: 'Geology Lab',           code: 'CVP2401', time: '2:00 PM', venue: 'Block IV, Rm 331',  type: 'lab', days: ['Monday'], note: 'F slot (PF2)' },
    { course: 'Hydraulics Lab',        code: 'CVP2702', time: '3:00 PM', venue: 'Block V, V312',      type: 'lab', days: ['Friday'] },
    { course: 'Eng Systems Lab',       code: 'MEP1000', time: '9:00 AM', venue: 'CSC',                type: 'lab', days: ['Monday'], note: 'Gr 1 & 2 together' },
  ],
  group3: [
    { course: 'Geology Lab',           code: 'CVP2401', time: '2:00 PM', venue: 'Block IV, Rm 331',  type: 'lab', days: ['Tuesday'], note: 'F slot (PF3)' },
    ...
    { course: 'Eng Systems Lab',       code: 'MEP1000', time: '9:00 AM', venue: 'CSC',                type: 'lab', days: ['Thursday'], note: 'Gr 3 & 4 together' },
  ],
  group4: [
    { course: 'Traffic Lab',           code: 'CVP2601', time: '3:00 PM', venue: 'Comp Lab 4-A-8',     type: 'lab', days: ['Monday'] },
    { course: 'Geology Lab',           code: 'CVP2401', time: '2:00 PM', venue: 'Block IV, Rm 331',  type: 'lab', days: ['Thursday'], note: 'F slot (PF4)' },
...
export const TIME_ORDER: Record<string, number> = {
  ...
  '12:00 PM': 1200, '1:00 PM': 1300, '2:00 PM': 1400, '3:00 PM': 1500, '5:00 PM': 1700,
};
